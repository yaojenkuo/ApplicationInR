...
```{r}
ggplotbp <- ggplot(data=partiesAsset, aes(x=parties, y=assetInMillionNTD, fill=color))+geom_bar(colour=NA, fill=color, width=.8, stat="identity")+ ggtitle(paste("民國103年政黨財務申報(具會計師簽證)","\n","單位:新台幣百萬元"))
```
